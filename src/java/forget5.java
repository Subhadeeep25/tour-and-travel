...
public class forget5 extends HttpServlet
{
        public void doGet(HttpServletRequest req,HttpServletResponse res)throws IOException,ServletException
    {
        ...
        try
        {
            ...
            String q1="select * from signup3 where name ='"+nm1+"'and id='"+nm2+"'";
...
"    </head>\n" +
"    <body bgcolor=\"pink\">\n" +
"        <form method =\"get\" action =\"forget6\">\n" +
"           \n" +
"            NEW PASS:<input type=\"password\" name=\"n1\"><br> <br>\n" +
